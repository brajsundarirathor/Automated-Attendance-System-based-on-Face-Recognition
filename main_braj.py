...
class Face_Recogition_System:
    def __init__(self,root):
        ...
        b2_lbl = Button(bg_lbl, text="Face Detector",cursor="hand2", font=("times new roman",15,"bold"),bg="darkblue",fg = "white")
        ...
        b3_lbl = Button(bg_lbl, text="Attendance",cursor="hand2", font=("times new roman",15,"bold"),bg="darkblue",fg = "white")
        ...
        b4_lbl = Button(bg_lbl, text="Help Desk",cursor="hand2", font=("times new roman",15,"bold"),bg="darkblue",fg = "white")
        ...
        b5_lbl = Button(bg_lbl, text="Train Data",cursor="hand2", font=("times new roman",15,"bold"),bg="darkblue",fg = "white")
        ...
        b5 = Button(bg_lbl,image=self.photoimg10,cursor="hand2")
        b5.place(x=750,y=330,width=200,height=150)
        b5_lbl = Button(bg_lbl, text="Developer",cursor="hand2", font=("times new roman",15,"bold"),bg="darkblue",fg = "white")
        ...
        b5 = Button(bg_lbl,image=self.photoimg11,cursor="hand2")
        b5.place(x=1050,y=320,width=200,height=150)
        b5_lbl = Button(bg_lbl, text="Exit",cursor="hand2", font=("times new roman",15,"bold"),bg="darkblue",fg = "white")
